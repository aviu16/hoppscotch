...
let cageResetCount = 0

export const getCageResetCount = (): number => cageResetCount
 ...
 */
export const isInfraError = (err: unknown): boolean => {
 ...
 *
 * TODO: Multi-tab or test-runner + manual-send overlap could cause concurrent
 * runCode() calls on the shared singleton. Consider a mutex/queue if this surfaces.
 */
